...
# Mirrors ../maya-scripts/UkorePlayblast/function.py's own _FILENAME_PATTERN
...
def parse_video_filename(video_path: Path) -> dict | None:
    ...
    hiding the video — it still plays and can still be commented on, it
    just can't get a generated share code (Mark as Share requires a parsed
    shot_code/version)."""
